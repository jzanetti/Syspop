...
_The above animations show: Top-left: the movements of 30 synthetic residents sampled from the area code 251400 (Wellington Central) in the early morning (between 7am and 8am). Top-right: Where people go to work in one day (3000 sampled synthetic citizens across Auckland region). Bottom-left: The reasons why people visit the SA2 area 241800 (Silverstream, Upper Hutt). Bottom-right: where people travel to from 241800 (Silverstream, Upper Hutt) between 7am and 8am_

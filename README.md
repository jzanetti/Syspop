...
To protect individuals' privacy, most census and survey data are provided in aggregated form. However, microsimulation models, such as agent-based models, typically require data at the individual level. **Syspop** is a package designed to streamline and modularize the process of synthesizing individual-level populations from aggregated data, improving both efficiency and ease of use. 

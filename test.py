...
from process.household import assign_people_to_household_wrapper
...
if assign_household_flag:
    ...
    base_pop = assign_people_to_household_wrapper(household_data["household"], base_pop["synpop"], use_parallel=True)
